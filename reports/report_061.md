...
## Verificación
**npm run build:** PASS
**Tests ejecutados:** npm run build + test inline getNextClass + verificación de guard horario=[]
**Comando de verificación:** npm run build && node -e "const { getNextClass } = require('./src/utils/horario.js'); /* casos today/next-day/empty */" && node -e "/* verifica guard de Sidebar con horario=[] */"
**Output de verificación:**
```
> scraper-app@0.1.0 build
> vite build
